<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/MNANTEC-SKRT MD/resources/ti.php' ?>
<html>
...
<head>
    ...
    <link href="/MNANTEC-SKRT MD/css/micss.css" rel="stylesheet">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <h5 class="mr-auto ml-3 ">
            <a class="titol btn" href="/MNANTEC-SKRT MD/index.php">
                Museu MNACTEC
            </a>
        </h5>
        ...
        <div class="mt-3 mb-3">
            <a class="btn btn-primary mr-3 titol right" href="/MNANTEC-SKRT MD/paginas/about/aboutus.php">Qui Som?</a>
        </div>
    </nav>
